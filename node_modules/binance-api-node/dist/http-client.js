...
var spotP = function spotP() {
  return "x-TKT5PX2F".concat(_uuid());
};
var futuresP = function futuresP() {
  return "x-cvBPrNm9".concat(_uuid());
};
...
var _default = exports.default = function _default(opts) {
  ...
  return {
    ...
    marginGetListenToken: function marginGetListenToken(payload) {
      return privCall('/sapi/v1/userListenToken', payload, 'POST');
    },
