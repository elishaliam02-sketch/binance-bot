...
export default class Binance {
     ...
     */
    classifyFuturesStream(endpoint) {
    ...
    getFStreamSingleUrl(category) {
        if (category) {
            if (this.Options.demo)
                return `wss://fstream.binancefuture.com/${category}/ws/`;
            if (this.Options.test)
                return `wss://stream.binancefuture.${this.domain}/${category}/ws/`;
    ...
    getFStreamUrl(category) {
        if (category) {
            if (this.Options.demo)
                return `wss://fstream.binancefuture.com/${category}/stream?streams=`;
            if (this.Options.test)
                return `wss://stream.binancefuture.${this.domain}/${category}/stream?streams=`;
